...
export const ROLES_DATA: Role[] = [
  ...
  {id:'1.2', name:'אחראי תחום תפעול ותשתיות',   cat:'ניהול',       rates:{b:207,c:243},              desc:'אחראי על ניהול צוות פיתוח ותשתיות. מתאם פיתוח תוכנה עם צרכי תשתית.'},
  ...
  {id:'1.6', name:'קצין ניהול פרויקטים PMO',     cat:'ניהול',       rates:{b:151,c:202,d:232},        desc:'אחראי על תהליכי PMO, תכנון, מעקב ובקרה על פרויקטים.'},
  {id:'2.1', name:'אחראי פרויקט',                cat:'פיתוח',      rates:{b:219,c:248,d:284},              desc:'מוביל פרויקט מקצה לקצה — תכנון, לוחות זמנים, תקציב וסיכונים.'},
  {id:'2.2', name:'מנהל מערכות',                 cat:'פיתוח',      rates:{a:151,b:174,c:218,d:240},  desc:'מנתח דרישות, מגדיר מפרטים פונקציונליים, מתאם בין לקוח לפיתוח.'},
  {id:'2.3', name:'מפתח תוכנה',                  cat:'פיתוח',      rates:{a:146,b:192,c:229,d:266},  desc:'מפתח קוד, בונה מודולים, אחראי על איכות הקוד ואינטגרציה.'},
  {id:'2.4', name:'בודק תוכנה',                  cat:'פיתוח',      rates:{a:99,b:128,c:170,d:184},   desc:'בודק מערכות, כותב תסריטי בדיקה, מאתר ומתעד באגים.'},
  {id:'2.5', name:'מידען / עורך תוכן',           cat:'פיתוח',      rates:{a:76,b:93,c:110},          desc:'מנהל מידע ותוכן דיגיטלי, אחראי על ארגון ידע ותיעוד.'},
  {id:'2.6', name:'אפיון חוויית וממשק משתמשים (ui-ux)', cat:'פיתוח',      rates:{a:142,b:169,c:201,d:235},  desc:'מעצב חוויית משתמש וממשקים (UX/UI), בונה אב-טיפוס ומבצע בדיקות שמישות.'},
  ...
  {id:'2.8', name:'איש ניתוח ויישום פלטפורמה',   cat:'פיתוח',      rates:{b:191,c:224},              desc:'מטמיע ומפתח פלטפורמות טכנולוגיות (CRM, ERP, BI וכו׳).'},
  {id:'2.9', name:'פיתוח DevOps',                 cat:'פיתוח',      rates:{a:185,b:232,c:280},        desc:'מבצע אוטומציה של תהליכי פיתוח, CI/CD, ניהול תשתיות ו-containerization.'},
  ...
  {id:'6.1', name:'אחראי מע׳ המידע',             cat:'ארכיטקטורה', rates:{b:284,c:323},        desc:'אחראי כולל על מערכות המידע הארגוניות — אסטרטגיה ותפעול.'},
  ...
  {id:'6.7', name:'ארכיטקט פתרונות',             cat:'ארכיטקטורה', rates:{b:275,c:340,d:358},        desc:'מגדיר ארכיטקטורת פתרונות עבור פרויקטים ספציפיים.'},
]
