...
export const PERSONAS: PersonaDefinition[] = [
  ...
  },
  {
    ...
    label: 'מנהל הרכש',
    shortLabel: 'מנהל רכש',
    description: 'מאשר מכרזים מעל 5,000,000 ₪ דרך מערכת אלמ"ה.',
    mainActions: ['אישור/דחיה דרך אלמ"ה', 'צפיה במגמות'],
    mainScreens: ['תור אישורים מערכתי', 'דשבורד ניהולי'],
    permissions: 'Read on Tender; Approve via אלמ"ה integration',
