...
9. שלב suppliers חייב להשתמש ב-cluster **התואם לאשכול הבריף/expertise** באותו מסע. אם הבריף ב-cluster_id=4 (ניהול מוצר) → suppliers cluster=product-management. אל תעתיק אשכול מדוגמה שלא מתאים לבקשה.
