...
| 23.08.2026 | merge לפרודקשן + **מסך `/settings` ייעודי** (`18c4ae6`, לפי פידבק תומר): "הפרופיל שלי" בסגנון מערכת הקבלנים — תמונה/פרטים/אבטחה/פרטיות; הטופבר מנווט אליו; /profile חזר להיות דף מסע בלבד. אומת חי בפרודקשן | QA תומר; אפיון פונקציונלי |
