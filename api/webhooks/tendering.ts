// Webhook receiver עבור מערכת התיחורים הדיגיטלית. Stub עם אימות bearer.
...
export default async function handler(req: any, res: any) {
  ...
  return res.status(200).json({
    ok: true,
    note: 'Tendering-system webhook stub — real signature verification when integration approved.',
  })
}
